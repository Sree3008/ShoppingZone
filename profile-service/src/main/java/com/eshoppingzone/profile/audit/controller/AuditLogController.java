package com.eshoppingzone.profile.audit.controller;
...
@RestController
@RequestMapping({"/api/v1/profiles/audit-logs", "/api/v1/audit-logs"})
@Tag(name = "Profile Audit Log Management", description = "Admin-only APIs for querying profile and address audit trails")
