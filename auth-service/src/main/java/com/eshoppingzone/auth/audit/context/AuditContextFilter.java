package com.eshoppingzone.auth.audit.context;
...
public class AuditContextFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        // Set correlation ID in response header so clients can trace it
        ...
        // Extract gateway-forwarded user headers if present
