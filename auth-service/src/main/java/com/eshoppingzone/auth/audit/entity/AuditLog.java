package com.eshoppingzone.auth.audit.entity;
...
@Table(name = "audit_logs", indexes = {
        ...
        @Index(name = "idx_auth_audit_actor_user_id", columnList = "actor_user_id"),
        @Index(name = "idx_auth_audit_action", columnList = "action"),
        @Index(name = "idx_auth_audit_resource", columnList = "resource_type, resource_id"),
        @Index(name = "idx_auth_audit_correlation_id", columnList = "correlation_id"),
        @Index(name = "idx_auth_audit_service_name", columnList = "service_name")
})
