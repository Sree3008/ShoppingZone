...
public class SecurityConfig {
    ...
    private com.eshoppingzone.payment.audit.service.AuditLogService auditLogService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/payments/process").hasAnyRole("INTERNAL", "ADMIN")
                        .requestMatchers("/api/v1/payments/cod/*/complete").hasAnyRole("INTERNAL", "ADMIN", "DELIVERY", "DELIVERY_AGENT")
