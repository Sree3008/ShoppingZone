...
public interface PaymentService {
    ...
    PaymentDto processPayment(ProcessPaymentRequest request, String idempotencyKey);
    ...
    RefundDto requestRefund(Long customerId, RefundRequest request, String idempotencyKey);
    RefundDto requestRefundInternal(RefundRequest request);
    RefundDto requestRefundInternal(RefundRequest request, String idempotencyKey);
