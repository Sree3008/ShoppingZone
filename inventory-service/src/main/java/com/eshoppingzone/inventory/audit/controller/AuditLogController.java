...
@RestController
@RequestMapping({"/api/v1/inventory/audit-logs", "/api/v1/audit-logs"})
@Tag(name = "Inventory Audit Log Management", description = "Admin-only APIs for querying inventory stock audit trails")
