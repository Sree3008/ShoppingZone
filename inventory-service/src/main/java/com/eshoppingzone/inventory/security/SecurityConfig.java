    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/inventory/product/*").permitAll()
                        .requestMatchers(
                        ...
                        .requestMatchers("/api/v1/inventory/product/*/movements").hasAnyRole("MERCHANT", "ADMIN", "INTERNAL")
