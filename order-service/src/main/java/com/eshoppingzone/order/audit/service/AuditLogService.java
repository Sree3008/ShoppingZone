package com.eshoppingzone.order.audit.service;

import com.eshoppingzone.order.audit.context.AuditContext;
import com.eshoppingzone.order.audit.dto.AuditLogDto;
import com.eshoppingzone.order.audit.entity.AuditLog;
import com.eshoppingzone.order.audit.event.AuditEvent;
import com.eshoppingzone.order.audit.repository.AuditLogRepository;
import com.eshoppingzone.order.audit.specification.AuditLogSpecification;
    ...
    public AuditLog log(String action,
        ...
        try {
            ...
            if (actorUserId != null || actorRole != null) {
                auditLog.setActorUserId(actorUserId != null ? actorUserId : "ADMIN");
                auditLog.setActorUsername(actorUsername != null ? actorUsername : "admin");
                auditLog.setActorRole(actorRole != null ? actorRole : "ROLE_ADMIN");
            } else {
