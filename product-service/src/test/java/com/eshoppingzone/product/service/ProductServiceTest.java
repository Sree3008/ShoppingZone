...
class ProductServiceTest {
    ...
    void testGetActiveProducts() {
        ...
        Page<ProductDto> pagedProducts = productService.getActiveProducts(null, null, null, null, PageRequest.of(0, 10));
        assertEquals(1, pagedProducts.getTotalElements());
        assertEquals("Test Laptop", pagedProducts.getContent().get(0).getName());
